...
begin
  ...
  ACtrlEstado.SetCtrlPais( ACtrlPais );
  ACtrlCidade.SetCrtlEstado( ACtrlEstado );
  ACtrlCargo.SetCtrlDepartamento( ACtrlDepartamento );
  ACtrlFuncionario.SetCtrlCargo( ACtrlCargo );
